  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        Header("RAM"),
        Option({
          opt: options.theme.bar.buttons.modules.ram.text,
          title: "Text",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.buttons.modules.ram.icon,
          title: "Icon",
          type: "color",
        }),
        Option({
        ...
        Header("CPU"),
        Option({
          opt: options.theme.bar.buttons.modules.cpu.text,
          title: "Text",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.buttons.modules.cpu.icon,
          title: "Icon",
          type: "color",
        }),
        Option({
        ...
        Header("Storage"),
        Option({
          opt: options.theme.bar.buttons.modules.storage.text,
          title: "Text",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.buttons.modules.storage.icon,
          title: "Icon",
          type: "color",
        }),
        Option({
        ...
        Header("Netstat"),
        Option({
          opt: options.theme.bar.buttons.modules.netstat.text,
          title: "Text",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.buttons.modules.netstat.icon,
          title: "Icon",
          type: "color",
        }),
        Option({
        ...
        Option({
          opt: options.theme.bar.buttons.modules.kbLayout.text,
          title: "Text",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.buttons.modules.kbLayout.icon,
          title: "Icon",
          type: "color",
        }),
        Option({
        ...
        Header("Updates"),
        Option({
          opt: options.theme.bar.buttons.modules.updates.text,
          title: "Text",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.buttons.modules.updates.icon,
          title: "Icon",
          type: "color",
        }),
        Option({
        ...
        Header("Weather"),
        Option({
          opt: options.theme.bar.buttons.modules.weather.icon,
          title: "Icon",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.buttons.modules.weather.text,
          title: "Text",
          type: "color",
        }),
        Option({
        ...
        Header("Power"),
        Option({
          opt: options.theme.bar.buttons.modules.power.icon,
          title: "Icon",
          type: "color",
        }),
        Option({
