      ...
      children: [
        ...
        Option(
          {
            ...
            subtitle:
              "Wiki Link: https://hyprpanel.com/configuration/panel.html#layouts",
            type: "object",
            subtitleLink:
        ...
        Option({
          opt: options.theme.bar.buttons.workspaces
            .numbered_active_highlight_border,
        ...
        Option({
          opt: options.theme.bar.buttons.workspaces
            .numbered_active_highlight_padding,
...
Forces each Monitor's Workspace labels to start from 1.`,
        ...
        Option({
          ...
          title: "Invert Scroll",
          subtitle:
            "Scrolling up will go to the previous workspace rather than the next.",
          type: "boolean",
        }),
        Option({
        ...
        Option({
          ...
          title: "Inner Spacing",
          subtitle:
            "Spacing between the icon and the label inside the buttons.",
          type: "string",
        }),
        Option({
        ...
        Option({
          ...
          subtitle:
            "Will truncate the network name to the specified size below.",
          type: "boolean",
        }),
        Option({
