  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        ...
        Option({
          opt: options.menus.dashboard.powermenu.reboot,
          title: "Reboot Command",
          type: "string",
        }),
        Option({
          opt: options.menus.dashboard.powermenu.logout,
          title: "Logout Command",
          type: "string",
        }),
        Option({
          opt: options.menus.dashboard.powermenu.sleep,
          title: "Sleep Command",
          type: "string",
        }),
        ...
        Option({
          ...
          title: "Track GPU",
          subtitle:
            "NOTE: This is currently only available for NVidia GPUs and requires 'python-gpustat'.",
          type: "boolean",
        }),
