    ...
    child: Widget.Box({
      ...
      children: [
        ...
        Option({
          ...
          title: "Radius",
          subtitle:
            "Radius of the on-screen-display that indicates volume/brightness change",
          type: "string",
        }),
        Option({
        ...
        Option({
          ...
          subtitle:
            "Display volume as 0 when muting, instead of previous device volume",
          type: "boolean",
        }),
      ],
    }),
