  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        ...
        Option({
          opt: options.theme.bar.menus.menu.clock.text,
          title: "Text",
          type: "color",
        }),
        ...
        Header("Card"),
        Option({
          opt: options.theme.bar.menus.menu.clock.card.color,
          title: "Card",
          type: "color",
        }),
        ...
        Header("Border"),
        Option({
          opt: options.theme.bar.menus.menu.clock.border.color,
          title: "Border",
          type: "color",
        }),
        ...
        Header("Time"),
        Option({
          opt: options.theme.bar.menus.menu.clock.time.time,
          title: "Time",
          type: "color",
        }),
        Option({
        ...
        Option({
          opt: options.theme.bar.menus.menu.clock.calendar.days,
          title: "Days",
          type: "color",
        }),
        Option({
        ...
        Option({
          opt: options.theme.bar.menus.menu.clock.weather.thermometer
            .extremelyhot,
