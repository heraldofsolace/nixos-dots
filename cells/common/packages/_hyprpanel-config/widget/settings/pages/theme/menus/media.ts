  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        ...
        Option({
          opt: options.theme.bar.menus.menu.media.song,
          title: "Song",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.menus.menu.media.artist,
          title: "Artist",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.menus.menu.media.album,
          title: "Album",
          type: "color",
        }),
        ...
        Header("Border"),
        Option({
          opt: options.theme.bar.menus.menu.media.border.color,
          title: "Border",
          type: "color",
        }),
        ...
        Option({
          opt: options.theme.bar.menus.menu.media.card.color,
          title: "Color",
          type: "color",
        }),
        Option({
        ...
        Option({
          opt: options.theme.bar.menus.menu.media.buttons.text,
          title: "Text",
          type: "color",
        }),
