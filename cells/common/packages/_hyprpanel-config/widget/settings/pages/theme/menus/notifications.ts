  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        ...
        Option({
          opt: options.theme.bar.menus.menu.notifications.card,
          title: "Card",
          type: "color",
        }),
        Option({
        ...
        Option({
          opt: options.theme.bar.menus.menu.notifications
            .no_notifications_label,
          title: "Empty Notifications Backdrop",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.menus.menu.notifications.border,
          title: "Border",
          type: "color",
        }),
        Option({
