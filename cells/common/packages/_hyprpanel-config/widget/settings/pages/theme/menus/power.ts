  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        ...
        Header("Border"),
        Option({
          opt: options.theme.bar.menus.menu.power.border.color,
          title: "Border",
          type: "color",
        }),
        ...
        Option({
          opt: options.theme.bar.menus.menu.power.buttons.shutdown
            .icon_background,
        ...
        Option({
          opt: options.theme.bar.menus.menu.power.buttons.logout
            .icon_background,
          title: "Icon Background",
          type: "color",
        }),
