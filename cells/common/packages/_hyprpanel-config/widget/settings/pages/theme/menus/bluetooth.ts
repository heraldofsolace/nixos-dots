  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        ...
        Option({
          opt: options.theme.bar.menus.menu.bluetooth.text,
          title: "Text",
          type: "color",
        }),
        ...
        Header("Card"),
        Option({
          opt: options.theme.bar.menus.menu.bluetooth.card.color,
          title: "Card",
          type: "color",
        }),
        ...
        Header("Label"),
        Option({
          opt: options.theme.bar.menus.menu.bluetooth.label.color,
          title: "Label",
          type: "color",
        }),
        ...
        Option({
          opt: options.theme.bar.menus.menu.bluetooth.switch.puck,
          title: "Puck",
          type: "color",
        }),
