  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        ...
        Option({
          opt: options.theme.bar.menus.menu.network.text,
          title: "Text",
          type: "color",
        }),
        ...
        Header("Card"),
        Option({
          opt: options.theme.bar.menus.menu.network.card.color,
          title: "Card",
          type: "color",
        }),
        ...
        Header("Border"),
        Option({
          opt: options.theme.bar.menus.menu.network.border.color,
          title: "Border",
          type: "color",
        }),
        ...
        Header("Label"),
        Option({
          opt: options.theme.bar.menus.menu.network.label.color,
          title: "Label",
          type: "color",
        }),
        ...
        Header("Icons"),
        Option({
          opt: options.theme.bar.menus.menu.network.icons.active,
          title: "Active",
          type: "color",
        }),
        Option({
