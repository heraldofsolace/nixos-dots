  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        Header("Card"),
        Option({
          opt: options.theme.bar.menus.menu.dashboard.card.color,
          title: "Card",
          type: "color",
        }),
        ...
        Option({
          opt: options.theme.bar.menus.menu.dashboard.powermenu.confirmation
            .card,
        ...
        Option({
          opt: options.theme.bar.menus.menu.dashboard.controls.bluetooth
            .background,
        ...
        Option({
          opt: options.theme.bar.menus.menu.dashboard.controls.notifications
            .background,
        ...
        Option({
          opt: options.theme.bar.menus.menu.dashboard.controls.volume
            .background,
          title: "Volume Button",
          type: "color",
        }),
        ...
        Header("Directories"),
        Option({
          opt: options.theme.bar.menus.menu.dashboard.directories.left.top
            .color,
          title: "Directory: Left - Top",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.menus.menu.dashboard.directories.left.middle
            .color,
          title: "Directory: Left - Middle",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.menus.menu.dashboard.directories.left.bottom
            .color,
          title: "Directory: Left - Bottom",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.menus.menu.dashboard.directories.right.top
            .color,
          title: "Directory: Right - Top",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.menus.menu.dashboard.directories.right.middle
            .color,
          title: "Directory: Right - Middle",
          type: "color",
        }),
        Option({
          opt: options.theme.bar.menus.menu.dashboard.directories.right.bottom
            .color,
