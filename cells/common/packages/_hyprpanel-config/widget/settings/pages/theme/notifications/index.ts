  ...
  return Widget.Scrollable({
    ...
    child: Widget.Box({
      ...
      children: [
        ...
        Option({
          opt: options.theme.notification.label,
          title: "Label",
          type: "color",
        }),
        Option({
          opt: options.theme.notification.border,
          title: "Border",
          type: "color",
        }),
        Option({
          opt: options.theme.notification.time,
          title: "Time Stamp",
          type: "color",
        }),
        Option({
          opt: options.theme.notification.text,
          title: "Body Text",
          type: "color",
        }),
        Option({
          ...
          title: "Label Icon",
          subtitle:
            "Icon that accompanies the label. Doesn't apply if icon is an app icon.",
          type: "color",
        }),
        Option({
