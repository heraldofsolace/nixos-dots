...
const options = mkOptions(OPTIONS, {
  theme: {
    ...
    font: {
      size: opt("1.2rem"),
      name: opt("JetBrainsMonoNL Nerd Font"),
      weight: opt(600),
    },
    notification: {
      scaling: opt(100),
    ...
    bar: {
      ...
      buttons: {
        ...
        windowtitle: {
          ...
          icon_background: opt(colors.yellow),
          spacing: opt("0.5em"),
        },
        media: {
          background: opt(colors.base2),
          ...
          text: opt(colors.lavender),
          icon: opt(colors.lavender),
          icon_background: opt(colors.mauve),
          spacing: opt("0.5em"),
        },
        volume: {
          background: opt(colors.base2),
        ...
        menu: {
          ...
          launcher: {
            ...
            search: {
              ...
              background: opt(tertiary_colors.surface2),
              border: opt(colors.surface1),
              placeholder: opt(colors.overlay2),
            },
            listitems: {
              passive: opt(colors.text),
              active: opt(secondary_colors.lavender),
          ...
          notifications: {
            ...
            switch: {
              ...
              disabled: opt(colors.text),
              puck: opt(colors.text),
            },
            pager: {
              show: opt(true),
              background: opt(colors.crust),
  ...
  menus: {
    ...
    dashboard: {
      powermenu: {
        ...
        shutdown: opt("shutdown now"),
        avatar: {
          image: opt(`${App.configDir}/assets/me9.png`),
      ...
      shortcuts: {
        left: {
          ...
          shortcut3: {
            icon: opt("󰓓"),
            tooltip: opt("Steam"),
            command: opt("steam-native"),
          },
          shortcut4: {
            icon: opt(""),
            tooltip: opt("Search Apps"),
            command: opt("menu:launcher"),
          },
        },
        right: {
          shortcut1: {
          ...
          shortcut3: {
            ...
            command: opt("service:snapshot.sh"),
          },
        },
      },
      directories: {
    ...
    clock: {
      ...
      weather: {
        ...
        key: opt<string>(Utils.readFile("/run/secrets/weatherapi-key").trim()),
      },
    },
    launcher: {
      width: opt(0),
      ...
      apps: {
        iconSize: opt(62),
        max: opt(6),
        favorites: opt([["firefox", "code", "dolphin"]]),
      },
    },
  },

  terminal: opt("wezterm-gui"),
